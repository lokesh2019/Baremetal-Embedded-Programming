...
#define CLK 16*1000*1000

#define DMA1EN (1U<<21)
#define DMA_SCR_EN (1U<<0)
#define DMA_SCR_MINC (1U<<10)
#define DMA_SCR_PING (1U<<9)
...
void uart2_rx_tx_init(void){
    ...
    /* 13. Enable USART2 intrrupt in the NVIC */
...
void dma1_init(void){
    ...
    /* Enable DMA Stream6 Interrupt to NVIC */
...
void dma1_stream5_uart_rx_config(void){
    ...
    /* Wait till DMA Steam is disabled */
